...
\begin{document}
    ...
    \begin{proof}[Dimostrazione II]
        Siano $N_1$ ed $N_2$ i seguenti NFA, tali da riconoscere rispettivamente i due linguaggi $A$ e $B$ in ipotesi: $$\left . \begin{array}{c}N_1 = (Q_1, \Sigma, \delta_1, q_1, F_1) \\ N_2 = (Q_2, \Sigma, \delta_2, q_2, F_2) \end{array} \right .$$ Allora, sia $N = (Q, \Sigma, \delta, q_0, F)$ il seguente NFA:
