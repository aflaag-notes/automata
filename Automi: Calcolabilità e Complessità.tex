...
\begin{document}
    ...
    \begin{frameddefn}{Espressione regolare}
        ...
        Un'espressione regolare, dunque, è un modo compatto di definire un linguaggio. Si noti che le definizioni successive sono in grado di espandere la definizione appena fornita.
    ...
    \begin{example}[GNFA]
        ...
        \begin{center}
            \includegraphics[scale=0.35]{assets/gnfa-neg.png}
        \end{center}
    \end{example}
