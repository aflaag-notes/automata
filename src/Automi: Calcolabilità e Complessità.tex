...
\begin{document}
    ...
    \begin{proof}
        ...
        Sia $$\mathcal M := \{\abk M \mid M \in \TM\}$$ che sarà necessariamente definito su qualche alfabeto $\Sigma$ in grado di rappresentare ogni sua possibile codifica; allora, poiché $\mathcal M \subseteq \Sigma^*$, e $\Sigma^*$ è numerabile per quanto detto in precedenza, segue che $\mathcal M$ è necessariamente nuerabile anch'esso
    \end{proof}
