...
\begin{document}
    ...
    \begin{framedthm}[label={p w red}]{In \Pclass mediante riduzione}
    ...
    \begin{framedcor}[label={p with red cor}]{Non in \Pclass mediante riduzione}
    ...
    \begin{proof}
        ...
        Dunque, poiché $V$ accetta $\abk{w, c}$
    ...
    \begin{framedthm}{$CLIQUE$ in \Pclass}
        TODO
    \end{framedthm}
    ...
    \begin{framedobs}{\curlyquotes{\Pclass versus \NPclass problem}}
        ...
        È ritenuto che $\Pclass \neq \NPclass$, ma tutt'ora non è ancora stato dimostrato.
    \end{framedobs}
\end{document}
