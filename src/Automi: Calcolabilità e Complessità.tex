...
\begin{document}
    ...
    \begin{frameddefn}{Turing-riconoscibilità}
        Un linguaggio è detto \tbf{Turing-riconoscibile} se esiste una macchina di Turing che lo riconosce. La classe dei linguaggi Turing-riconoscibili è denotata con $\mathrm{REC}$, dunque in simboli $$L \in \mathrm{REC} \iff \exists M \in \mathrm{TM} \mid L(M) = L$$
    \end{frameddefn}
    ...
    \begin{frameddefn}{Turing-decidibilità}
        Un linguaggio è detto \tbf{Turing-decidibile} se esiste un decisore che lo riconosce. La classe dei linguaggi Turing-decidibili è denotata con $\mathrm{DEC}$.
    \end{frameddefn}
\end{document}
