...
\begin{document}
    ...
    \begin{proof}
        ...
        Allora, considerando $\mathcal M \subseteq \Sigma ^*$ l'insieme delle codifiche di \TM, poiché per il \cref{num tm} esso è numerabile, per quanto dimostrato in precedenza segue necessariamente che esiste un linguaggio, definito su $\Sigma$ stesso, che non può essere riconosciuto da nessuna macchina di Turing in $\mathcal M$.
    \end{proof}
