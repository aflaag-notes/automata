...
\begin{document}
    ...
    % \end{frameddefn}
    %
    % \begin{framedlem}{D\PDA equivalenti}
    ...
    \begin{framedprop}{Equivalenza delle N\TM}
        Sia $N$ una N\TM; allora esiste una \TM $M$ ad essa equivalente.
    \end{framedprop}
    ...
    \section{Problema dell'accettazione}

    \subsection{\DFA}

    \begin{frameddefn}{TODO}
        TODO
    \end{frameddefn}
