...
\begin{document}
    ...
    \begin{frameddefn}{Classe \coNLSPACE}
    ...
    \begin{framedobs}{Gerarchia delle classi}
        TODO METTI QUESTA OBS NEL POSTO GIUSTO (controlla teoremi di gerarchia) E NOMINA I TEOREMI E FIXA IL DISEGNO AGGIUNGENDO EXPSPACE=NEXPSPACE
