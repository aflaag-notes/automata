...
\begin{document}
    ...
    \begin{framedthm}{\coNPclass-completezza dei complementi}
        Dato un linguaggio $L$, si ha che $$L \in \NPComplete \iff \overline L \in \coNPComplete$$
    \end{framedthm}

    \begin{proof}
        $$\centeredsoe{L \in \NPComplete \iff \soe{l}{L \in \NPclass \\ \forall L' \in \NPclass \quad L' \leq_\mathrm P L} \iff \soe{l}{L \in \NPclass \\ \forall L' \in \NPclass \quad \overline{L'} \leq_\mathrm P L} \iff \\ \iff \soe{l}{\overline L \in \coNPclass \\ \forall \overline{L'} \in \coNPclass \quad \overline{L'} \leq_\mathrm P \overline L} \iff \overline L \in \coNPComplete}$$
    \end{proof}
