...
\begin{document}
    ...
    \begin{framedprop}{Altezza delle derivazioni di CFG in CNF}
    ...
    \begin{proof}
        Poiché $A$ è un CFL, per definizione esiste una CFG $G = (V, \Sigma, R, S)$ che lo genera; sia allora $p = 2^{|V|}$. TODO
    \end{proof}
