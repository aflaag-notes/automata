...
\begin{document}
    ...
    \begin{framedthm}[label={coturing thm}]{CoTuring-riconoscibilità e decidibilità}
        Un linguaggio è decidibile se e solo se è Turing-riconoscibile e coTuring-riconoscibile; in simboli $$L \in \DEC \iff L \in \REC \cap \COREC$$
    \end{framedthm}
